...
const STOCK_LIST = [
  // Blue chips / Ibovespa principais
  ...
  // Mid caps e small caps relevantes
  'ALPA4','ALSO3','AMAR3','AMBP3','ANIM3','ARML3','ATOM3',
  'BEEF3','BIDI11','BMGB4','BOVA11','BRFS3','BRKM5','BRPR3',
  'CARD3','CASH3','CBAV3','CCRO3','CEAB3','CGAS5','CGRA4',
  'CLSA3','CNTB3','COCE5','COHL3','CRFB3','CSMG3','CVCB3',
  'DESK3','DIRR3','DMVF3','DXCO3','ECOR3','ENAT3','ENEV3',
  'ENGI11','EUCA4','EVEN3','EZTC3','FESA4','FHER3','FIQE3',
  'GGPS3','GMAT3','GRND3','GUAR3','HBSA3','HBTS5','HETA4',
  'IFCM3','IGTI11','INEP4','INTB3','IRBR3','JHSF3','JSLG3',
  'KEPL3','LAVV3','LCAM3','LEVE3','LJQQ3','LOGG3','LOGN3',
  'LPSB3','LUPA3','MDNE3','MDIA3','MELK3','MERC4','MILS3',
  'MLFT4','MOVI3','MRFG3','MRVE3','MULT3','MYPK3','NATU3',
  'NCPL3','NEOE3','NTCO3','OIBR3','OMGE3','ONCO3','OPCT3',
  'PARD3','PDTC3','PLPL3','PORT3','PNVL3','POMO4','PTBL3',
  'PTNT4','RAIZ4','RCSL4','RLOG3','ROMI3','SAPR11','SEER3',
  'SEQL3','SHOW3','SIMH3','SLCE3','SMAL11','SMFT3','SMLS3',
  'SQIA3','SRTX3','STBP3','SULA11','TASA4','TEND3','TGMA3',
  'TIMS3','TKNO4','TPIS3','TRAD3','TRIS3','TRXF11','TUPY3',
  'UGPA3','UNIP6','VAMO3','VBBR3','VIIA3','VITT3','VLID3',
  'VVEO3','WEST3','WIZC3','XBRL3','YDUQ3','ZAMP3'
];
...
const FII_LIST = [
  ...
  'ALZR11','ARRI11','BBFI11','BBPO11','BCRI11','BPFF11','BRCO11',
  'BREV11','BTCR11','CJCT11','CVBI11','DEVA11','EDGA11','EURO11',
  'FEXC11','FIIB11','FIGS11','FIIP11','FINF11','FLMA11','FLRP11',
  'FMOF11','FOFT11','FVPQ11','GARE11','GTWR11','HABT11','HCTR11',
  'HFOF11','HGCR11','HGFF11','HGPO11','HGRE11','HGRU11','HLOG11',
  'HMOC11','HSAF11','HSRE11','IRDM11','ITIP11','ITRI11','JFLL11',
  'JSAF11','JSRE11','KINP11','KNCR11','KNHY11','KNIP11','KNSC11',
  'LOFT11','LPLP11','MALL11','MBRF11','MGFF11','MGHG11','MOCI11',
  'MORC11','MSHP11','NCHB11','NEWL11','NVHO11','OUJP11','PATC11',
  'PLRI11','PORD11','PVBI11','RBCO11','RBFF11','RBHG11','RBIV11',
  'RBRF11','RBRL11','RBRY11','RBVA11','RCRB11','RECR11','RELG11',
  'RETO11','RFOF11','RNDP11','RNGO11','RPRI11','RSPD11','RZAG11',
  'RZTR11','SNCI11','SNFF11','STRE11','TBTL11','TEPP11','TFOF11',
  'TORD11','TRBL11','TRXB11','TVRI11','UBSR11','URPR11','VCJR11',
  'VCRA11','VGIP11','VGHF11','VGIA11','VGIR11','VGRI11','VIGT11',
  'VIUR11','VLOL11','VPSI11','VSLH11','WPLZ11','WTSP11','XBXO11',
  'XPCA11','XPCM11','XPCI11','XPCO11','XPHT11','XPIN11','XPLB11',
  'XPPR11','XPVG11','YUFI11','ZCCM11'
];
