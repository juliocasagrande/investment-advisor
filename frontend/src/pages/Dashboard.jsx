...
export default function Dashboard() {
  ...
  // grandTotal inclui previdência privada no patrimônio exibido
  const grandTotal = summary.grandTotal ?? summary.totalValue ?? 0;
  const pensionValue = summary.pensionValue ?? 0;
